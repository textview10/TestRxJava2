...
public class DrawUtil {
    ...
    public static void drawBesier(Canvas canvas, Paint paint, LineInfo lineInfo, TransPointF transPointF) {
        canvas.drawPath(PathFactory.createBesier(lineInfo, transPointF), paint);
    }
    ...
    public static void drawPath(Canvas canvas, LineInfo lineInfo, TransPointF transPointF) {
        ...
        switch (lineInfo.getType()) {
            ...
            case 1:
                ...
                break;
            case 2:
                drawRect(canvas, transPointF.logic2Display(pointInfos.get(0).getPointF()),
                        transPointF.logic2Display(pointInfos.get(1).getPointF()), paint);
                break;
            case 3:
                drawOval(canvas, transPointF.logic2Display(pointInfos.get(0).getPointF()),
                        transPointF.logic2Display(pointInfos.get(1).getPointF()), paint);
                break;
            case 4:
                drawArrow(canvas, transPointF.logic2Display(pointInfos.get(0).getPointF()),
                        transPointF.logic2Display(pointInfos.get(1).getPointF()), paint);
                break;
            case 5:
                drawShiZiGe(canvas, transPointF.logic2Display(pointInfos.get(0).getPointF()),
                        transPointF.logic2Display(pointInfos.get(1).getPointF()), paint);
                break;
            case 6:
                drawMiZhiGe(canvas, transPointF.logic2Display(pointInfos.get(0).getPointF()),
                        transPointF.logic2Display(pointInfos.get(1).getPointF()), paint);
                break;
            case 7:
                drawSiXianGe(canvas, transPointF.logic2Display(pointInfos.get(0).getPointF()),
                        transPointF.logic2Display(pointInfos.get(1).getPointF()), paint);
                break;
            case 8:
